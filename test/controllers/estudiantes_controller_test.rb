...
class EstudiantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estudiante" do
    assert_difference('Estudiante.count') do
      post estudiantes_url, params: { estudiante: { codigo: @estudiante.codigo, descripcion: @estudiante.descripcion, edad: @estudiante.edad, estado: @estudiante.estado, nombre: @estudiante.nombre } }
    end
  ...
  test "should update estudiante" do
    patch estudiante_url(@estudiante), params: { estudiante: { codigo: @estudiante.codigo, descripcion: @estudiante.descripcion, edad: @estudiante.edad, estado: @estudiante.estado, nombre: @estudiante.nombre } }
